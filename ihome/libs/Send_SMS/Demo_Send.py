# 文件名: Flask_Project_Code -> Demo_Send
# 创建时间: 2020/6/3 19:36
# coding=utf-8

from .Send_REST import REST
...
class CCP(object):
	...
	def instance():
		if not hasattr(CCP, "_instance"):
			CCP._instance = CCP()
			print("初始化CCP.instance")
		return CCP._instance
	
	def sendTemplateSMS(self, to, datas, tempId):
		try:
			print("to, datas, tempId: ", to, datas, tempId)
...
if __name__ == "__main__":
	ccp = CCP.instance()
	res = ccp.sendTemplateSMS("13207297072", ["456", 5], 1)
	print(res)
	...
	这是请求包体:
	<?xml version="1.0" encoding="utf-8"?><SubAccount><datas><data>1234</data><data>5</data></datas><to>185xxxxxxxx
	</to><templateId>1</templateId><appId>xxxxxx</appId>            </SubAccount>
	这是响应包体:
